...
class Component(ComponentBase):
    ...
    def run(self):
        ...
        analyze_messages_in_file(in_file_name=input_table.full_path, text_column=text_column,
                                 out_file_name=out_table.full_path, out_file_columns=final_columns,
                                 base_prompt=base_prompt, openai_key=api_token)
